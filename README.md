...
- **Community orchestration**
  - `/community` - global atlas, upcoming salons, and member narratives
  - `/community/passport` - journey timeline, tier privileges, and concierge channels
  - `/forum` - discourse integration for mastermind discussions
...
Task 13 is now in motion:

- `/community` has relaunched with the Community Atlas, luxury salon calendar, and member narratives aligned to the new editorial scaffolding.
- `/community/passport` translates the guild journey into a staged passport with tier privileges and concierge touchpoints.
- Community helpers power atlas insights, region summaries, and Vitest coverage so analytics and CI can trust the new data flows.
